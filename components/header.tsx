// for functionality of FramerMotion
"use client";
...
export default function Header() {
  ...
  return (
    <header className="relative z-[999]">
      <motion.div
        className="broder-white fixed left-1/2 top-0 h-[4.5rem] w-full 
        rounded-none border border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03]
